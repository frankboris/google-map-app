...
const CheckedRadioIcon = React.memo(({color, size}) => (
    <svg color={color} height={size + "pt"} width={size + "pt"} viewBox="0 0 510 510" xmlns="http://www.w3.org/2000/svg">
        <path
            fill={color}
